...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/silent-darkness-935b
```

A live public deployment of this template is available at [https://silent-darkness-935b.templates.workers.dev](https://silent-darkness-935b.templates.workers.dev)
